...
import { CalendarIcon, HomeIcon, LightbulbIcon, MailIcon, PencilIcon, ReceiptText, UsersRound } from "lucide-react";
  ...
  return (
    <div className="fixed top-6 right-1/2 translate-x-1/2 gap-10 w-full justify-between z-50 dark flex">
      <div className="pl-3">
        <NeonGradientCard borderRadius={100} className="w-28 h-28 top-4 cursor-pointer">
          <div className="flex justify-center items-center w-full h-full">
            <Image src="/logo.png" alt="logo" className="rounded-full" width={105} height={110} draggable={false} onClick={() => router.push("/")}/>
          </div>
        </NeonGradientCard>
      </div>
      ...
      <TooltipProvider>
        ...
        {/* ⭐ Added: perfect center wrapper */}
        <div className="absolute left-1/2 -translate-x-1/2">

        <Dock direction="middle" className="bg-white w-fit gap-7">
            ...
            <DockIcon key={name}>
              <Tooltip>
                <TooltipTrigger asChild>
                  {name === 'email' ? (
                    <button
                      onClick={() => window.open("mailto:biz@wireplay.asia", "_blank")}
